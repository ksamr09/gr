...
print ("\n\n ---  WELCOM TO ERIC BOTS  First login from here line://app/1602687308-GXq4Vvk9?type  ---\n")
achink = LINE()
achink.log("Auth Token : " + str(achink.authToken))
achink.log("Timeline Token : " + str(achink.tl.channelAccessToken))
#======================================================#
print ('-----------------------------------------------------')
print ('--B͍O͍T͍ L͍O͍G͍I͍N͍-')
print ('----------------------------------------------------')
print ('---self bot py Eric -')
...
def sendMentionFooter(to, mid, firstmessage, lastmessage):
    try:
        ...
        ticket = "https://line.me/ti/p/fBPWEBDnCk"
        ...
        if op.type == 15:
          if settings["Leave"] == True:
           ...
           "contents": [
                              ...
                              "type": "uri",
                              "label": "لاعاد ترجع",
                              "uri": "https://line.me/ti/p/fBPWEBDnCk"
                          }
                     },
                ]
           },
        ...
        if op.type == 25:
            ...
            if msg.contentType == 0:
                ...
                if text.lower() == "sp" or text.lower() == "speed":
                    start = time.time()
                    achink.sendMessage("ua2a16c028374c836e12a3a33cd013936","test speed...")
                    ...
                    data = {
                                           ...
                                           "sentBy": {
                                           "label": "Eric",
                                           "iconUrl": "https://github.com/ksamr09/shield/blob/master/1560635855804.jpg",
                                           "uri": "line://ti/p/fBPWEBDnCk"
                                         }
                                     }
                    sendTemplate(to, data)
  ...
  "contents": [
              ...
              "contents": [
                            ...
                            if a["items"] != []:
                                ...
                                for music in a["items"]:
                                    ret_.append({
                                        ...
                                        "hero": {
                                            "type": "image",
                                            "url": "https://github.com/ksamr09/shield/blob/master/1560635855804.jpg".format(music['id']['videoId']),
                                            "size": "full",
                                            "aspectRatio": "20:13",
                                            "aspectMode": "cover",
                                            "action": {
                ...
                if text.lower() == "panduan/bc":
                    ...
                    sa+="\n-Contoh> <"
                    sa+="\n-bc/aboutme.."
                    data = {"type": "text","text": "{}".format(sa),"sentBy": {"label": "Eric", "iconUrl": "https://obs.line-scdn.net/{}".format(achink.getContact(achinkMID).pictureStatus),"linkUrl": "line://nv/profilePopup/mid=u6e4534dd63e82642f29205d2c993c642"}}
                    sendTemplate(to,data)
                ...
                if text.lower() == "stag":
                    ...
                    sa += "\nContoh"
                    sa += "\nstag 1 @user"
                    data = {"type": "text","text": "{}".format(sa),"sentBy": {"label": "Eric", "iconUrl": "https://obs.line-scdn.net/{}".format(achink.getContact(achinkMID).pictureStatus),"linkUrl": "line://nv/profilePopup/mid=u266f0d1211f905b2ca386024d9d4e165"}}
                    sendTemplate(to,data)
                ...
                "contents": [
                            ...
                            "hero": {
                            "type": "image",
                            "url": "https://github.com/ksamr09/shield/blob/master/1560635855804.jpg",
                    #        "url": "https://obs.line-scdn.net/{}".format(achink.getContact(achinkMID).pictureStatus),
                            "size": "full",
                        #    "aspectRatio": "1:1",
                        #    "aspectMode": "fit",
       ...
       # "type": "button",
        ...
        #  "uri": "https://line.me/ti/p/fBPWEBDnCk",
                ...
                "contents": [
                            ...
                            "hero": {
                            "type": "image",
                       #     "url": "https://images.app.goo.gl/XKkpoXqdqvvuN1hcA",
                            "url": "https://obs.line-scdn.net/{}".format(achink.getContact(achinkMID).pictureStatus),
                            "size": "full",
                        #    "aspectRatio": "1:1",
                        #    "aspectMode": "fit",
                ...
                "contents": [
                            ...
                            "hero": {
                            "type": "image",
                        #    "url": "https://github.com/ksamr09/shield/blob/master/1567447585807.jpg",
                            "url": "https://obs.line-scdn.net/{}".format(achink.getContact(achinkMID).pictureStatus),
                            "size": "full",
                        #    "aspectRatio": "1:1",
                        #    "aspectMode": "fit",
                ...
                if text.lower() == "me2":
                    ...
                    s = temp["te"]
                    a = temp["t"]
                    data={"type":"flex","altText":"{} sendFlex".format(name),"contents":{"type":"bubble",'styles': {"body":{"backgroundColor":"#000000"}},"hero":{"type":"image","url":cover,"size":"full","aspectRatio":"20:13","aspectMode":"cover"},"body":{"type":"box","layout":"vertical","contents":[{"type":"text","text":" "},{"type":"image","url":profile,"size":"full"},{"type":"text","text":" "},{"type":"text","text":name,"size":"xl","weight":"bold","color":s,"align":"center"},{"type":"text","text":" "},{"type":"text","text":status,"align":"center","size":"xs","color":s,"wrap":True},{"type":"text","text":"𝑺𝑯𝑰𝑬𝑳𝑫 𝑩𝑶𝑻"},{"type":"button","style":"primary","color":"#3d3d40","action":{"type":"uri","label":"ADD ME","uri":"line://app/1602687308-GXq4Vvk9?type=video&ocu=Eric"}}]}}}
                    sendTemplate(to, data)
                if text.lower() == "meyyyy2":
                    contact = achink.getContact(sender)
                    sendTemplate(to,{"type":"flex","altText": "𝑺𝑯𝑰𝑬𝑳𝑫","contents":{"type":"bubble","footer":{"type":"box","layout":"horizontal","contents":[{"color":"#000000","size":"xs","wrap":True,"action":{"type":"uri","uri":"line://app/1636169025-yQ7bGMVA?type=profile"},"type":"text","text":"🛫Eric🛫","align":"center","weight":"bold"},{"type":"separator","color":"#000000"},{"color":"#000000","size":"xs","wrap":True,"action":{"type":"uri","uri":"line://ti/p/fBPWEBDnCk"},"type":"text","text":"Chat_Me","align":"center","weight":"bold"}]},"styles":{"footer":{"backgroundColor":"#8b0000"},"body":{"backgroundColor":"#000000"}},"body":{"type":"box","contents":[{"type":"box","contents":[{"type":"separator","color":"#000000"},{"aspectMode":"cover","gravity":"bottom","aspectRatio":"1:1","size":"sm","type":"image","url":"https://github.com/ksamr09/shield/blob/master/1567447585807.jpg"},{"type":"separator","color":"#000000"},{"type":"image","aspectMode":"cover","aspectRatio":"1:1","size":"sm","url":"https://github.com/ksamr09/shield/blob/master/1561494339788.jpg"},{"type":"separator","color":"#FF69B4"},{"type":"image","aspectMode":"cover","aspectRatio":"1:1","size":"sm","url":"https://github.com/ksamr09/shield/blob/master/1560635855804.jpg"},{"type":"separator","color":"#000000"},{"type":"image","aspectMode":"cover","aspectRatio":"1:1","size":"sm","url":"https://github.com/ksamr09/shield/blob/master/1560635855804.jpg"},{"type":"separator","color":"#FF69B4"}],"layout":"vertical","spacing":"none","flex":1},{"type":"separator","color":"#FF69B4"},{"type":"box","contents":[{"type":"separator","color":"#FF69B4"},{"color":"#413877","size":"md","wrap":True,"type":"text","text":"Anyma Bot","weight":"bold"},{"type":"separator","color":"#FF69B4"},{"color":"#413877","size":"md","wrap":True,"type":"text","text":"{}".format(contact.displayName),"weight":"bold"},{"type":"separator","color":"#FF69B4"},{"color":"#FF69B4","size":"xs","wrap":True,"type":"text","text":"Status Profile:","weight":"bold"},{"type":"text","text":"{}".format(contact.statusMessage),"size":"xxs","wrap":True,"color":"#422002"}],"layout":"vertical","flex":2}],"layout":"horizontal","spacing":"md"},"hero":{"aspectMode":"cover","margin":"xxl","aspectRatio":"1:1","size":"full","type":"image","url":"https://obs.line-scdn.net/{}".format(contact.pictureStatus)}}})
                elif text.lower() == "me":
                            s = temp["te"]
                            a = temp["t"]
                            contact = achink.getContact(achinkMID)
                            ...
                            dataProfile = [
                                {
                                    ...
                                    "styles": {
                                        ...
                                        "footer": {"backgroundColor": "#3d3d40", "separator": True, "separatorColor": "#3d3d40"}
                                    },
                                    "hero": {
                                        "type": "image",
                                        "url": "https://obs.line-scdn.net/{}".format(contact.pictureStatus),
                                        ...
                                        "contents": [
                                            {
                                                ...
                                                "contents": [
                                                    ...
                                                    },
                                                    {
                                                        ...
                                                        "action": {
                                                            "type": "uri",
                                                            "uri": "http://line.me/ti/p/fBPWEBDnCk"
                                                        }
                                                    },
                                                    {
                                                        "type": "spacer",
                                                	...
                                                	"actions": [
                                                		{
                                                			"type": "uri",
                                                			"label": "Youtube",
                                                			"uri": "https://m.youtube.com/channel/UCqAk2EvmA86wthggifn2D_VA/"
                                                		}
                                                	]                                                		
                                                },
                                                {
    ...
    "contents": [
      ...
      "type": "button",
                    ...
                    try:
                        ...
                        ret_ = "\n◾ الاسم : {}".format(contact.displayName)
                        ret_ += "\n◾ عدد المجموعات : {}".format(str(len(grouplist)))
                        ret_ += "\n◾ الأصدقاء : {}".format(str(len(contactlist)))
                        ret_ += "\n◾ المحظورين : {}".format(str(len(blockedlist)))
                        ret_ += "\n◾️ الدعوات المعلقة : {}".format(str(len(IdsInvit)))
                        ret_ += "\n◾ الوقت  :{}".format(str(runtime))
                        ret_ += "\n◾ الصانع : {}".format(str(creator.displayName))
  ...
  "footer": {
    ...
    "contents": [
      ...
      "type": "button",
                    ...
                    ret_ += "\n🔹اسم المجموعة    : {}".format(str(group.name))
                    ret_ += "\n🔹 رقم المجموعة          : {}".format(group.id)
                    ret_ += "\n🔹 مؤسس المجموعة : {}".format(str(gCreator))
                    ret_ += "\n🔹 الاعضاء         : {}".format(str(len(group.members)))
                    ret_ += "\n🔹 المعلقون       : {}".format(gPending)
                    ret_ += "\n🔹 الرابط           : {}".format(gQr)
                    ret_ += "\n🔹رابط المجموعة       : {}".format(gTicket)
                    ret_ +="\n____________________________"
                    ret_ += "\n✳️Eric✳️"
                    data = {
                        "type": "flex",
...
#=========================================================
                if text.lower() == "autolike on":
                    ...
                    data = {"type": "text","text": "{}".format(am),"sentBy": {"label": "Eric", "iconUrl": "https://obs.line-scdn.net/{}".format(achink.getContact(achinkMID).pictureStatus),"linkUrl": "line://nv/profilePopup/mid=u6e4534dd63e82642f29205d2c993c642"}}
                    sendTemplate(to,data)
...
#==================================================================================================
 ...
 #=========================================
                    ...
                    if msg.toType == 2:
                       group = achink.getGroup(to)
                       achink.sendMessage(to, "bye "+str(group.name))
